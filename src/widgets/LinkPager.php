...
class LinkPager extends Widget
{
     ...
     */
    public $options = ['class' => 'pagination justify-content-center m-0'];
    /**
    ...
    public $navOptions = ['class'=>'Contacts Page Navigation'];


    public $pageCssClass = ['class'=>'page-item'];
    /**
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        return Html::tag('nav', Html::a($label, $this->pagination->createUrl($page), $linkOptions), $options, $navOptions);
    }
